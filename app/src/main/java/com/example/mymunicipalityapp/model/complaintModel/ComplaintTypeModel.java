...
public class ComplaintTypeModel extends ObjectTypeModel {

    private Context mCtx;

    private  final String SHARED_PREF_NAME = "ComplaintTypeModel";
    private  final String KEY_TITLE= "title";
    private  final String KEY_ID = "id";


    public ComplaintTypeModel(Context context) {
        mCtx = context;
    }
