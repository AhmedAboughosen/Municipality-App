...
public class TextViewEx extends AppCompatTextView
{
    ...
    public TextViewEx(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        //set main_logo minimum of left and right padding so that the texts are not too close to the side screen
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        if (cacheEnabled) {
            ...
            {
                // Create main_logo bitmap and set the activeCanvas
